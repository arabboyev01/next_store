                    ...
                    <form onSubmit={handleSubmit} noValidate style={{width: '100%'}}>
                        <Box className={classes.itemsContainer}>
                            <Box className={classes.fieldContainer}>
                                <CssTextField {...LOGIN_FORM_VALUES.username} placeholder="E-mailingizni kiriting"
                                              type="text"/>
                            </Box>
                            <Box className={classes.fieldContainer}>
                                <label className={classes.seePassword} onClick={handleVisible}>
                                    {visible ? <VisibilityOffIcon className={classes.icon}/> :
                                        <VisibilityIcon className={classes.icon}/>}
                                </label>
                                <CssTextField {...LOGIN_FORM_VALUES.password} placeholder="Parol"
                                              type={visible ? 'text' : 'password'}/>
                                {showError ? <Typography className={classes.showErrors}>Username yoki Parol
                                    xato</Typography> : null}
                            </Box>
