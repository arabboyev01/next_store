...
import Success from '../CartSummary/Success'

const CartSummary: React.FC<CartSummaryType> = ({handleForm, cart, totalQTY, totalAmount, success}) => {
            ...
            {success ? <Success/> :
                <Box className={navState ? classes.sticky : classes.summaryWrapper}>
                    ...
                    <Box className={classes.summa}>
                        ...
                        <Typography
                            className={classes.priceCenter}>{commafy(totalAmount + 40000)} so&apos;m</Typography>
                    </Box>
